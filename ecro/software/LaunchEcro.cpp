...
/************************************************************************/
LaunchEcro::LaunchEcro() { }

/************************************************************************/
bool LaunchEcro::configure(ResourceFinder &rf) {

    printf(BOLDBLUE);
    printf("LaunchEcro options:\n");
    ...
    if (!robotDevice.isValid())
    {
        ...
        RD_ERROR("Be sure CMake \"ENABLE_EcroYarp_%s\" variable is set \"ON\"\n",type.c_str());
