...
/************************************************************************/
bool LaunchRd2::configure(ResourceFinder &rf) {

    printf(BOLDBLUE);
    printf("LaunchRd2 options:\n");
    ...
    if (!robotDevice.isValid())
    {
        ...
        RD_ERROR("Be sure CMake \"ENABLE_Rd2Yarp_%s\" variable is set \"ON\"\n",type.c_str());
